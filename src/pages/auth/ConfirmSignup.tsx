            ...
            <div className="bg-surface py-8 px-4 shadow-sm sm:rounded-2xl sm:px-10 border border-surface-border">
              <div className="text-center space-y-4">
                ...
                <div className="space-y-3">
                  <h3 className="text-2xl font-bold text-ink">Account Confirmed!</h3>
                  <p className="text-ink-muted">
                    🎉 Your email <span className="font-medium text-accent-deep">{email}</span> has been successfully confirmed.
                  </p>
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-surface py-8 px-4 shadow-sm sm:rounded-2xl sm:px-10 border border-surface-border">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              {/* Resend success */}
              {resendSuccess && (
                <div className="bg-sage-dim border border-sage-dim text-sage px-4 py-3 rounded-lg flex items-center space-x-2">
                  <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
              ...
              <div className="text-center space-y-3">
                <div>
                  <button
                    ...
                    className="text-sm text-accent-deep hover:text-accent disabled:opacity-50 transition-colors"
                  >
